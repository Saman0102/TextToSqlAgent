"""Canonical source for schema loading. Do not import from any other location.

Merged from: app/schema.py, app/core/schema.py.
Supports loading schema from both JSON and SQL files.
"""
